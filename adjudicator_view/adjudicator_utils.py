...
from video.models import Person, Vehicle, Citation, Video, Image, CourtDates, adj_metadata, Data, Tattile, TattileFile
...
class AdjudicatorUtils:
    ...
    @staticmethod
    def save_citation_data(station_name,station_id, citation_id, person, vehicle, court_date, 
                           date_object, fields, speed_pic, plate_pic, fine_amount):
        """
        ...
        if fields['mediaType'] == 1:
            ...
            plate_pic=plate_pic,
            note=fields['note'],
            dist=fields['distance'] if fields['distance'] else 0,
...
def update_existing_citation_data(fields, citationID, mediaType, videoId=None, imageId=None, 
                                  isAdjudicated=False, isSent=False, personId=None, vehicleId=None, 
                                  station_id=None, tattileId=None, fine_amount=None):
